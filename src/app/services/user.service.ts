...
export class UserService {
  ...
  async getAllBusinessOwners(): Promise<any[]> {
    const { data, error } = await this.supabase.from('business_owners').select('*');
  ...
  async addBusinessOwner(businessOwner: any): Promise<any | null> {
    const { data, error } = await this.supabase.from('business_owners').upsert([businessOwner]);
  ...
  async updateBusinessOwner(businessOwner: any): Promise<any | null> {
    const { data, error } = await this.supabase.from('business_owners').upsert([businessOwner]);
  ...
  async deleteBusinessOwner(id: string): Promise<boolean> {
    const { error } = await this.supabase.from('business_owners').delete().eq('id', id);
